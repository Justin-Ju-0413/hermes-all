...
- **Solidot RSS**: Solidot (奇客Solidot) RSS at `https://www.solidot.org/index.rss` is in XML (RSS 2.0) and parses cleanly with `xml.etree.ElementTree`. It has ~20 items covering Chinese-translated tech/science news. Filter for tech/AI relevance since it also covers general science and social topics.
...
- See `references/tech-news-sources.md` for the full source database
