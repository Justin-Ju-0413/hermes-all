#!/usr/bin/env node
/**
 * Playwright Stealth Scraper (Proxy Edition)
 * 適用：有 Cloudflare 或反爬保護的網站，通過 mihomo 代理訪問
 * 速度：中等（5-10 秒）
 * 反爬能力：中（隱藏自動化、真實 UA）
 * 
 * Usage: node playwright-stealth-proxy.js <URL>
 * 
 * 環境變數：
 ...
 * - PROXY=socks5h://...    代理地址（默認 socks5h://127.0.0.1:7890）
 */
...
const proxyUrl = process.env.PROXY || 'socks5://127.0.0.1:7890';
